  ...
  return (
    ...
    >
      <div className="yt-player__wrapper">
        <div id="yt-player-iframe" className="yt-player__iframe" />
        ...
        <div className={`yt-player__controls ${showControls ? 'visible' : ''}`}>
          {/* Play/Pause — center */}
          <button
            className="yt-player__btn yt-player__btn--play"
            onClick={togglePlay}
          ...
          <div className="yt-player__bottom-controls">
            <button
              className="yt-player__btn yt-player__btn--mute"
              onClick={toggleMute}
